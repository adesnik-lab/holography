%%% This is the implemetnation of SEQUENTIAL Gerchberg Saxton algorithm. 
%%% Optional, System.GSoffset hyperparameter

function [ GS ] = function_sequentialGS(System, HStacks, Masks )
if System.verbose == 1
...
for n = 1:System.maxiter
    ...
    for i = index
        ...
        tempim = ifft2(ifftshift(imagez))./HStacks(:,:,i);
    end
...
if System.verbose == 1
    t = toc;
    disp(' ');
    disp(['Sequential Gerchberg-Saxton - Completed in ' int2str(t) ' seconds !']);
end;
