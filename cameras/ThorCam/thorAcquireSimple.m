function avg = thorAcquire(framesToAverage, Setup)
...
numberOfFramesToAcquire = framesToAverage;
frameCount = 0;
avgData = zeros(1080,1920,framesToAverage); % preallocate data to average;
