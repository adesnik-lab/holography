function dataOut = thorAcquireN(framesToAcquire, Setup)
...
frameCount = 0;
dataOut = zeros(1080,1920,framesToAcquire,'uint16'); % preallocate data to average;
...
while frameCount < numberOfFramesToAcquire
    ...
    if (tlCamera.NumberOfQueuedFrames > 0)
        ...
        if ~isempty(imageFrame)
            ...
            dataOut(:,:,frameCount)=imageData2D';
        end
